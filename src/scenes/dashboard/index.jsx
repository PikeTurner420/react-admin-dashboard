...
import Pie from "../../components/DashboardPieChart";
...
class Dashboard extends Component {
  ...
  getMonthEarn() {
    ...
    fetch("http://localhost:3050/dashboard/monthearn")
      ...
      .then((data) => {
        const {monthgoal} = this.state
        this.setState({
          monthearn: data[0].sum,
          progressmont: data[0].sum / monthgoal,
        });
      })
      ...
      <Box m="20px">
        ...
        >
          ...
          >
            <StatBox
              title={monthearn}
              subtitle="Month Earning"
              progress={progressmont}
              increase={monthgoalstring}
              icon={
                <PointOfSaleIcon
          ...
          <Box gridColumn="span 4" gridRow="span 2" backgroundColor="#1F2A40">
            <Typography
              variant="h5"
              fontWeight="600"
